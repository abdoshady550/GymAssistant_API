...
namespace GymAssistant_API.Data.Migrations
{
    ...
    [Migration("20251026131757_AddChatFeature")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.Chat.ChatConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.Chat.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.User.TrainerRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TrainerId", "TraineeId", "Status");
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.User.UserRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.Chat.ChatMessage", b =>
                {
                    b.HasOne("GymAssistant_API.Model.Entities.Chat.ChatConversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GymAssistant_API.Model.Entities.User.ClientProfile", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("GymAssistant_API.Model.Entities.Notifications.DeviceToken", b =>
                {
                    b.HasOne("GymAssistant_API.Model.Entities.User.AppUser", "User")
                        .WithMany()

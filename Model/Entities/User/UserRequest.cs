...
{
    public sealed class UserRequest : Entity
    {
        ...
        private UserRequest(Guid id, Guid trainerId, Guid traineeId, string? message = null)
            : base(id)
        {
            TrainerId = trainerId;
            TraineeId = traineeId;
        ...
        public static Result<UserRequest> Create(Guid id,
                                                    Guid trainerId,
                                                    Guid traineeId,
                                                    string? message = null)
        {
            ...
            return new UserRequest(id, trainerId, traineeId, message);
        }

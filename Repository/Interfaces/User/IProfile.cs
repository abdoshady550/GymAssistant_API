...
namespace GymAssistant_API.Repository.Interfaces.User
{
    public interface IProfile
    {
        ...
        Task<Result<Updated>> UpdateProfileAsync(Guid userId, string firstName, string lastName, Gender gender, string? phoneNumber, DateTime? birthDate, int? heightCm, CancellationToken ct = default);
